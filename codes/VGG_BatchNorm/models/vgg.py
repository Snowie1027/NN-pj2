...
class VGG_A_BatchNorm_Light(nn.Module):
    def __init__(self, inp_ch=3, num_classes=10):
        super().__init__()
...
if __name__ == '__main__':
    ...
    print("VGG_A_BatchNorm_Light:", get_number_of_parameters(VGG_A_BatchNorm_Light()))
    print("VGG_A_BatchNorm_Dropout:", get_number_of_parameters(VGG_A_BatchNorm_Dropout()))
